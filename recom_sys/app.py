...
ITEMS = [
    ...
    {"itemId": 3, "title": "百年孤独", "type": "book", "authorDirector": "加西亚·马尔克斯", "releaseYear": 1967, "ratingAvg": 9.2, "ratingCount": 850, "viewCount": 4000, "coverUrl": "https://img3.doubanio.com/view/subject/s/public/s27270478.jpg", "description": "《百年孤独》，是哥伦比亚作家加西亚·马尔克斯创作的长篇小说...", "createdAt": datetime.now().isoformat()},
    ...
    {"itemId": 6, "title": "红楼梦", "type": "book", "authorDirector": "曹雪芹", "releaseYear": 1791, "ratingAvg": 9.6, "ratingCount": 2000, "viewCount": 10000, "coverUrl": "https://img3.doubanio.com/view/subject/s/public/s27270481.jpg", "description": "《红楼梦》是一部百科全书式的长篇小说...", "createdAt": datetime.now().isoformat()},
    ...
    {"itemId": 102, "title": "阿甘正传", "type": "movie", "authorDirector": "罗伯特·泽米吉斯", "releaseYear": 1994, "ratingAvg": 9.5, "ratingCount": 2500, "viewCount": 12000, "coverUrl": "https://img3.doubanio.com/view/photo/s/public/p510876377.jpg", "description": "阿甘于二战结束后不久出生...", "createdAt": datetime.now().isoformat()},
    {"itemId": 103, "title": "盗梦空间", "type": "movie", "authorDirector": "克里斯托弗·诺兰", "releaseYear": 2010, "ratingAvg": 9.3, "ratingCount": 2200, "viewCount": 11000, "coverUrl": "https://img3.doubanio.com/view/photo/s/public/p513344864.jpg", "description": "道姆·柯布与同事阿瑟...", "createdAt": datetime.now().isoformat()},
    {"itemId": 104, "title": "泰坦尼克号", "type": "movie", "authorDirector": "詹姆斯·卡梅隆", "releaseYear": 1997, "ratingAvg": 9.4, "ratingCount": 2800, "viewCount": 14000, "coverUrl": "https://img3.doubanio.com/view/photo/s/public/p457760035.jpg", "description": "1912年4月10日...", "createdAt": datetime.now().isoformat()},
    {"itemId": 105, "title": "星际穿越", "type": "movie", "authorDirector": "克里斯托弗·诺兰", "releaseYear": 2014, "ratingAvg": 9.3, "ratingCount": 2100, "viewCount": 10500, "coverUrl": "https://img3.doubanio.com/view/photo/s/public/p2206088801.jpg", "description": "近未来的地球黄沙遍野...", "createdAt": datetime.now().isoformat()},
    {"itemId": 106, "title": "楚门的世界", "type": "movie", "authorDirector": "彼得·威尔", "releaseYear": 1998, "ratingAvg": 9.3, "ratingCount": 2300, "viewCount": 11500, "coverUrl": "https://img3.doubanio.com/view/photo/s/public/p479682983.jpg", "description": "楚门是一个平凡得不能再平凡的男子...", "createdAt": datetime.now().isoformat()}
]

# 标签表 tb_tags
TAGS = [
    {"tagId": 1, "tagName": "科幻", "itemCount": 4},
    {"tagId": 2, "tagName": "悬疑", "itemCount": 4},
    {"tagId": 3, "tagName": "成长", "itemCount": 3},
    {"tagId": 4, "tagName": "经典", "itemCount": 4},
    {"tagId": 5, "tagName": "爱情", "itemCount": 2},
    {"tagId": 6, "tagName": "历史", "itemCount": 2}
]

# 内容-标签关联表 tb_item_tags
ITEM_TAGS = [
    {"itemId": 1, "tagId": 1}, # 三体 - 科幻
    {"itemId": 105, "tagId": 1}, # 星际穿越 - 科幻
    {"itemId": 103, "tagId": 1}, # 盗梦空间 - 科幻
    {"itemId": 103, "tagId": 2}, # 盗梦空间 - 悬疑
    {"itemId": 6, "tagId": 2}, # 红楼梦 - 悬疑 (just sample logic from js)
    {"itemId": 6, "tagId": 4}, # 红楼梦 - 经典
    {"itemId": 6, "tagId": 5}, # 红楼梦 - 爱情
    {"itemId": 4, "tagId": 2}, # 围城 - 悬疑
    {"itemId": 101, "tagId": 2}, # 肖申克 - 悬疑
    {"itemId": 101, "tagId": 4}, # 肖申克 - 经典
    {"itemId": 106, "tagId": 2}, # 楚门 - 悬疑
    {"itemId": 5, "tagId": 3}, # 平凡的世界 - 成长
    {"itemId": 5, "tagId": 6}, # 平凡的世界 - 历史
    {"itemId": 2, "tagId": 3}, # 活着 - 成长
    {"itemId": 102, "tagId": 3}, # 阿甘 - 成长
    {"itemId": 102, "tagId": 4}, # 阿甘 - 经典
    {"itemId": 3, "tagId": 4}, # 百年孤独 - 经典
    {"itemId": 104, "tagId": 5}, # 泰坦尼克 - 爱情
]
...
def api_favorite_item(item_id):
            ...
            if DB.get('type') == 'sqlalchemy':
                ...
                with conn.begin():
                    ...
                    if ex:
                        ...
                        return jsonify({'code': 200, 'message': '操作成功', 'data': {'isFavorited': False}, 'timestamp': int(datetime.now().timestamp() * 1000)})
                    else:
                        ...
                        return jsonify({'code': 200, 'message': '操作成功', 'data': {'isFavorited': True}, 'timestamp': int(datetime.now().timestamp() * 1000)})
            else:
                cur = conn.cursor()
                cur.execute("SELECT 1 FROM tb_favorites WHERE user_id=%s AND item_id=%s", (user['userId'], item_id))
                ex = cur.fetchone()
    ...
    if existing:
        ...
        is_favorited = True
    return jsonify({'code': 200, 'message': '操作成功', 'data': {'isFavorited': is_favorited}, 'timestamp': int(datetime.now().timestamp() * 1000)})
...
def api_recommendations_compat(item_type):
    """兼容旧的 script.js 调用，直到 js 更新完毕"""
    # 这个接口实际上会被新 script.js 弃用，但保留以防万一
